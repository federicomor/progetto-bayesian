...
# ╔═╡ f5783787-bf50-4de3-ad61-8da4c7834c34
using PlutoUI

# ╔═╡ 60738f56-c13f-4024-93e4-77ae8ef394a4
using Plots

# ╔═╡ 8f48f6c5-2942-4d6a-b16d-9dcb55057251
using Printf
...
if plot_selected == "ARI"
	PlutoUI.LocalResource("$(root_folder)/$(model_selected)/$(plot_selected)/ari.png")
else
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "5017c388e33701351f983ac9d082802ee32af1eb"
