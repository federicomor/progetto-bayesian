...
pari = ggplot(dati,aes(x=x))+
	...
	abline(aes(y=y1,color= "DRPM - sPPM"               ))+
	abline(aes(y=y2,color= "DRPM - Gaussian PPMx"      ))+
	abline(aes(y=y3,color= "DRPM - Curve PPMx"         ))+
	abline(aes(y=y4,color= "sPPM - Gaussian PPMx"      ))+
	abline(aes(y=y5,color= "sPPM - Curve PPMx"         ))+
	abline(aes(y=y6,color= "Gaussian PPMx - Curve PPMx"))+
        # ylim(-0.2, 0.8) +
        # xlim(1, 80) +
	theme_bw()+ 
