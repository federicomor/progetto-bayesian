...
$$LPPD(model j) = sum_{i=1}^n log( m(y_i | y_{vector}, M_j) )$$
...
```{r}
load("../data/fit_test.Rdata") # just to have a working example
...
Actually can be useful about understanding for how much time run the MCMC.
