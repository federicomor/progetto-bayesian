...
covariates=df_weekly[,3:39]
covariates=covariates[,-c(3,5,9,19,36)]    #not numerical
covariates=covariates[,-c(1,2,3,31)]   #lat, long, alti and land_use constant over same station
k = dim(covariates)[2]
head(dati)
# df_stat=hash() ????
...
for (st in stations[1:4]){
 ...
 #run model  
  ...
  #summary(outputRegress)$quantiles[30:57,]   #print of ind 
  
  #HERE NEED THRESHOLD AND TO STORE
