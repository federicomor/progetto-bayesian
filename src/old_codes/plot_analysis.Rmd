...
data_16_to_21 = rbind(data2016,data2017,data2018,data2019,data2020,data2021)
time_trend <- ggplot()
...
time_trend <- ggplot(data_16_to_21, aes(x = Time, y = AQ_pm10, color = as.factor(year(Time)))) +
  geom_line() +
  labs(x = "Time", y = "PM_10 values", title = paste0("Station ", st, ", all years")) +
...
# Aggiungi la legenda
time_trend <- time_trend + theme(legend.position = "top")

file_name = "trend_gif"
# gif
output_file <- paste0("./gifs/",file_name,".gif")
anim_save(output_file,time_trend)
