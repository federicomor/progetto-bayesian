...
heatmap(t(nas[,1:141]),Colv=NA, Rowv=NA,col = c("white", "darkred"), scale='none',xlab="days",ylab="stations",
...
heatmap(t(nas), Colv = NA, Rowv = NA, col = c("white", "darkred"), scale = 'none', xlab = "days", ylab = "stations",
        ...
        add.expr = {
        	...
        	pad=80
			text(x=c(0,366, 731, 1096, 1461, 1827)+pad, y=10,
				 cex=0.7,c("2016","2017","2018","2019","2020","2021"))
        })
# dev.off()
