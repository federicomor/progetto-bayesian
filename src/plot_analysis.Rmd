...
gradient_map <- 
	grid+
  geom_tile(data = data_from_to_lomb, aes(x = Longitude, y = Latitude, fill = chosen_variable), colour = "grey50",width = 1, height = 1,alpha = 0.2) +
...
if (facetted){
	...
	ggtitle(gradient_map$Time) +
	transition_time(gradient_map$Time)+
