...
\institute[polimi]{
	Politecnico of Milano\\Bayesian Statistics% \smallskip 
...
\begin{frame}
	\frametitle[Project definition]{Project definition}
	
	\textbf{Goal:} Clustering weekly data of one year of PM10 (plus covariates - see AGRIMONIA project)\\
	...
	\textbf{Dataset:} \href{https://zenodo.org/records/7563265   }{\texttt{https://zenodo.org/records/7563265}}
\end{frame}
